...
public class ItemReactiveCrudRestRepositoryParametrizedTests {
    ...
    void createTest() throws Exception {
        MvcResult mvcResult = this.mockMvc
                .perform(post("/api/reactive/items").content(ITEM_TEST_STRING))
    ...
    void readAllTest() throws Exception {
        this.mockMvc.perform(get("/api/reactive/items"))
                .andExpect(status().isOk())
    ...
    private static Stream<String> initUri() {
        return Stream.of(
                ItemReactiveCrudRestRepositoryParametrizedTests.getUri().getPath()
        );
    }
}
