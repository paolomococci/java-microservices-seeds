...
import local.example.seed.controller.CustomerReactiveRestController;
...
public class CustomerRepresentationModelAssembler
    ...
    public EntityModel<Customer> toModel(Customer customer) {
        return EntityModel.of(customer,
                linkTo(methodOn(CustomerReactiveRestController.class).read(customer.getId())).withSelfRel(),
                linkTo(methodOn(CustomerReactiveRestController.class).readAll()).withRel("customers"));
    }
