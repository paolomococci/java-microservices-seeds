...
public class RootController {
    ...
    @FXML
    private void menuItemSampleOne() {
        app.initSampleOneView();
    }
    
    @FXML
    private void menuItemSampleTwo() {
        app.initSampleTwoView();
    }
    
    @FXML
    private void menuItemSampleThree() {
        app.initSampleThreeView();
    }
    
    @FXML
    private void menuItemSampleFour() {
        app.initSampleFourView();
    }
    ...
    @FXML
    private void menuItemCanvasOne() {
        app.initCanvasOneView();
    }
